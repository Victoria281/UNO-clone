                                    ...
                                    {userStats.score.map((score, index) => {
                                        ...
                                        return (
                                            <Box className={styles.leaderboard_player}>
                                                <Box className='row no-gutters'>
                                                    <Box className="col-sm-1" sx={{ paddingY: 2 }}>
                                                        <Typography variant='h6' align='center' sx={{ padding: 1, fontWeight: 'bold' }}>{index + 1}</Typography>
                                                    </Box>
                                                    <Box className="col-sm-2" sx={{ paddingY: 2 }}>
                                                        <Typography variant='h6' align='center' sx={{ padding: 1 }}>{score.game_status === 0 ? "Loose" : "Win"}</Typography>
                                                    </Box>
                                                    <Box className="col-sm-2" sx={{ paddingY: 2 }}>
                                                        <Typography variant='h6' align='center' sx={{ padding: 1 }}>{score.score}</Typography>
                                                    </Box>
                                                    <Box className="col-sm-7" sx={{ paddingY: 2 }}>
                                                        <Typography variant='h6' align='center' sx={{ padding: 1 }}>{fullDate}</Typography>
                                                    </Box>
                                                </Box>
                                            </Box>
                                        );
